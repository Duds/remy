...
def test_is_configured_missing_token(tmp_path):
    from drbot.google.auth import is_configured

    missing = str(tmp_path / "nope.json")
    # ADC may be configured on this machine — mock it out so we test the
    # "no token file, no ADC" code path cleanly.
    with patch("drbot.google.auth._try_adc", side_effect=Exception("no ADC")):
...
def test_extract_doc_id_from_url():
    from drbot.google.docs import extract_doc_id
...
def test_extract_text_from_doc():
    from drbot.google.docs import _extract_text
...
def test_gmail_is_promotional():
    from drbot.google.gmail import _is_promotional
...
def test_extract_name():
    from drbot.google.contacts import _extract_name
...
def test_extract_emails():
    from drbot.google.contacts import _extract_emails
...
def test_extract_birthday_with_date():
    from drbot.google.contacts import _extract_birthday
...
def test_format_contact_basic():
    from drbot.google.contacts import format_contact
...
def test_get_sparse_contacts_filters_correctly():
    ...
    from drbot.google.contacts import ContactsClient
